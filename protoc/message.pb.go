...
type Message struct {
	...
	IsBid         bool                   `protobuf:"varint,5,opt,name=IsBid,proto3" json:"IsBid,omitempty"` // Is query or is bid
...
const file_message_proto_rawDesc = "" +
	"\n" +
	"\rmessage.proto\x12\x05proto\"\x98\x01\n" +
	"\aMessage\x12\x1c\n" +
	"\tTimestamp\x18\x01 \x01(\x03R\tTimestamp\x12\x16\n" +
	"\x06UserID\x18\x02 \x01(\x05R\x06UserID\x12\x1c\n" +
	"\tAuctionID\x18\x03 \x01(\x05R\tAuctionID\x12\x19\n" +
	"\x05Price\x18\x04 \x01(\x05H\x00R\x05Price\x88\x01\x01\x12\x14\n" +
	"\x05IsBid\x18\x05 \x01(\bR\x05IsBidB\b\n" +
	"\x06_Price\"I\n" +
	"\bResponse\x12\x18\n" +
	"\aSuccess\x18\x01 \x01(\bR\aSuccess\x12\x19\n" +
	"\x05Price\x18\x02 \x01(\x05H\x00R\x05Price\x88\x01\x01B\b\n" +
	"\x06_Price2F\n" +
	"\x0eAuctionService\x124\n" +
	"\rAuctionStream\x12\x0e.proto.Message\x1a\x0f.proto.Response(\x010\x01B\x03Z\x01.b\x06proto3"
...
var file_message_proto_depIdxs = []int32{
	...
	1, // 1: proto.AuctionService.AuctionStream:output_type -> proto.Response
